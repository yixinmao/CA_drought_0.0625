...
int main (int argc, char *argv[])   // accumulative ET (Nov - Mar) for each year [km3]
{
  ...
  for(i=0;i<nfiles;i++){
    ...
    tot_area+=area;
    sprintf(filename,"/raid2/ymao/other/CA_drought_0.0625/run_vic/model_output/fluxes_1920_20140731_old2014_adjustT_pivot2014/fluxes_%.5f_%.5f",lat,lon);
	...
	{
	evap_year[year-syear+1]+=evap*area/1000/1000;
      }
