...
int main (int argc, char *argv[])   // accumulative prec (Apr - Jul) for each year [km3]
{
  ...
  for(i=0;i<nfiles;i++){
    ...
    tot_area+=area;
    sprintf(filename,"/raid2/ymao/other/CA_drought_0.0625/run_vic/model_output/fluxes_1920_20140731_old2014/fluxes_%.5f_%.5f",lat,lon);
