...
#define END_MONTH 3  // assume that end_day is 1 
/////////////////////////
...
int main (int argc, char *argv[])   // accumulative prec (Nov 1 - Mar 19) for each year [km3]
{
  ...
  for(i=0;i<nfiles;i++){
	...
	else if(month<=END_MONTH-1 || (month==END_MONTH && day<=1))  // if Jan - Apr1, add it to this water year
	{
